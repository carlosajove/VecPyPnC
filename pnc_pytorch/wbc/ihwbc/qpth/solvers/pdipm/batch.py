...
from pnc_pytorch.wbc.ihwbc.qpth.util import get_sizes, bdiag #TODO: rechange this when conda


"""
Carlos: 
Have updated torch.lu to torch.linalg.lu_factor
torch.lu_solve to torch.linalg.lu_solve
"""
...
def forward(Q, p, G, h, A, b, Q_LU, S_LU, R, eps=1e-12, verbose=0, notImprovedLim=3,
    ...
    if solver == KKTSolvers.LU_FULL:
        ...
        #print("S_LU 1", S_LU)
        factor_kkt(S_LU, R, d)
        #print("hey, hey", Q_LU, d, G) 
        #print("hey 2 ","S_LU" , S_LU)
        #print("hey 3", p, torch.zeros(nBatch, nineq).type_as(Q))
        #print("hey4", -h)
...
""")
    ...
    if neq > 0:
        ...
        #CARLOS print(S_LU_11, S_LU_12)
        #CARLOS print("second", S_LU_21, S_LU_22)
        #CARLOS print("NANANNA", S_LU_12, S_LU_21)
