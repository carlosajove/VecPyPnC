...
if __name__ == "__main__":
    ...
    com_vel = []
    torso_com_link_quat = []
    torso_link_ang_vel_des = []
    torso_com_link_quat = []
    torso_com_link_ang_vel = []
    r_foot_contact_pos_des = []
    r_foot_contact_vel_des = []
    r_foot_contact_pos = []
    r_foot_contact_vel = []
    l_foot_contact_pos_des = []
    l_foot_contact_vel_des = []
    l_foot_contact_pos = []
    l_foot_contact_vel = []
    r_foot_contact_quat_des = []
    r_foot_contact_ang_vel_des = []
    r_foot_contact_quat = []
    r_foot_contact_ang_vel = []
    l_foot_contact_quat_des = []
    l_foot_contact_ang_vel_des = []
    l_foot_contact_quat = []
    l_foot_contact_ang_vel = []



    with open('data/pnc.pkl', 'rb') as f:
        while True:
            data = pickle.load(f)
            time
